...
def pad_sequences(data, max_length):
    ...
    for sentence, labels in data:
        ...
        pad_sent = sentence[:max_length] + max(0,(max_length-len(sentence)))*[zero_vector]
        pad_labels = labels[:max_length] + max(0,(max_length-len(sentence)))*[zero_label]
        mask = [True]*len(labels[:max_length])+[False]*max(0,(max_length-len(sentence)))
        ret.append((pad_sent,pad_labels,mask))
        ### END YOUR CODE ###
    return ret
